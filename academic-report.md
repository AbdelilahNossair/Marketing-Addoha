...
- **+18% increase** in residential electricity tariffs in 2024 (ONEE Morocco)
- **62% of Moroccan households** cite energy bills as their primary post-purchase financial concern (HCP Survey 2024)
- **MAD 600/month** average household energy expenditure in urban Morocco (industry estimate)

The Moroccan middle-income buyer can often afford the mortgage payment. What erodes their financial stability — and creates hesitation at the point of purchase — is the cumulative burden of post-purchase living costs, of which energy is the largest controllable component.

Any marketing strategy for Addoha must address this reality to be credible with the target segment.
...
|---|---|
| Product | Unchanged physical product; enhanced buying journey |
| Price | Protect realized price through financing clarity and subsidy communication |
...
| Component | Amount |
|---|---|
| Annual operating budget | MAD 20–25M |
...
|---|---|---|---|
| Conservative | +0.5% | +2% | ~MAD 26M |
| Base | +0.75% | +3% | ~MAD 39M |
| Ambitious | +1.0% | +5% | ~MAD 59M |
...
|---|---|
| Product | Solar water heaters (-40% hot water cost), thermal insulation (-15–25% cooling/heating), optimized orientation. No complex technology or structural changes required. |
| Price | MAD 7,000 premium with 2-year payback and MAD 30,000 in 10-year savings. The product is framed as an investment, not a cost. |
...
|---|---|---|
| Green features per unit | MAD 6,000 | COGS (recovered via MAD 7,000 premium) |
| Supplier & engineering setup | ~MAD 5M | One-time capex |
| Annual campaign | MAD 5–8M | Recurring opex |
| **Investment-to-revenue ratio** | **~0.3%** | |
...
|---|---|---|---|
| Pilot | 5,000 | +3% | ~MAD 24.8M |
| Conservative | 8,000 | +3% | ~MAD 27.8M |
...
- A 1.2% volume lift is achieved (Lever B alone)

Both thresholds are conservative relative to Addoha's 10,195-unit annual Eco & MS pre-sales volume.

| Scenario | Year-one cost | Gross profit uplift | Net ROI |
|---|---|---|---|
| Conservative (Year 1) | MAD 13M (campaign + setup) | MAD 27.8M | **+114%** |
| Ambitious (Year 2+) | MAD 8M (campaign only) | MAD 45.0M | **+463%** |
...
|---|---|---|---|
| **Annual marketing cost** | MAD 20–25M | MAD 5–8M | **AGH** (3× leaner) |
| **Investment-to-revenue ratio** | ~0.9% | ~0.3% | **AGH** |
| **Margin mechanism** | Behavioral (less discounting) | Structural (product design) | **AGH** (more predictable) |
| **Time to first impact** | 3–6 months | 12–18 months | **WMD** (faster) |
| **Competitive moat** | Low (digital funnel copyable in 3–6 months) | Medium (product requires supply chain, 6–12 month copy lag) | **AGH** |
| **Customer benefit duration** | Episodic (during purchase) | Permanent (monthly savings, 20+ years) | **AGH** |
| **Execution risk** | Low (operational, reversible) | Medium (supply chain, construction QC) | **WMD** |
...
AGH's margin lever is embedded in the product specification before construction begins. The MAD 1,000 margin difference materializes automatically when a green unit is sold at the listed price. It does not require discount discipline, CRM adoption, or behavioral change.
...
|---|---|---|---|
| Annual marketing spend | MAD 22.5M (midpoint) | MAD 6.5M (midpoint) | AGH is **3.5× cheaper** |
...
AGH's competitive advantage requires supplier negotiations, engineering validation, staff training, and a full construction cycle. Even after a competitor decides to respond, they face a 6–12 month implementation lag. This creates a meaningful first-mover window.
...
$$\text{Incremental GP} = \text{Green units sold} \times \text{MAD 1,000/unit}$$

At 10,000 units: MAD 10.0M in direct margin uplift.

**Volume acceleration (Lever B):**

$$\text{Volume GP} = \text{\% volume lift} \times \text{MAD 659.8M base GP}$$

At +5%: MAD 33.0M in volume-driven uplift.
...
$$\text{Price GP} = \text{\% price lift} \times \text{MAD 2,594.7M revenue} \times 25.4\% \text{margin}$$

At +0.75%: ~MAD 19.5M in price-driven uplift.

**Volume acceleration (Lever 2):**

At +3%: MAD 19.8M in volume-driven uplift.
...
| Metric | WMD | AGH |
|---|---|---|
| Base-case gross profit uplift | MAD 39.3M | MAD 43.0M |
| Annual marketing investment | MAD 22.5M | MAD 6.5M |
| **Return per MAD 1 invested** | **MAD 1.75** | **MAD 6.62** |
| Year-1 net ROI (incl. setup) | ~74% | ~114% |
| Year-2+ net ROI | ~75% | ~463% |

**AGH generates comparable gross profit uplift at one-third the marketing cost, yielding a return per dirham invested that is nearly 4× higher than WMD.**
...
| Item | Amount |
|---|---|
| One-time premium paid | MAD 7,000 |
| Monthly energy savings | ~MAD 250 |
| Annual savings | ~MAD 3,000 |
| Payback period | **~2.3 years** |
| 10-year cumulative savings | **~MAD 30,000** |
| 10-year ROI on premium | **329%** |
| 20-year cumulative savings | **~MAD 60,000+** (assuming rising energy tariffs) |
...
| Item | Nature |
|---|---|
| Benefit type | Smoother purchasing journey |
| Tangible savings | None (no change to the physical product) |
...
| Dimension | WMD | AGH |
|---|---|---|
| Tangible financial benefit to buyer | None | MAD 30,000 over 10 years |
| Duration | 3–6 months (purchase period) | 20+ years (lifetime of home) |
| Word-of-mouth potential | Low (process is private) | High ("my bill dropped 40%") |
| Buyer loyalty driver | Convenience | Ongoing financial gratitude |

**AGH creates a permanent, measurable, compounding financial benefit for the customer. WMD improves the purchase process but adds zero long-term value to the product itself.**
...
3. **Higher return on investment:** MAD 6.62 returned per MAD 1 invested vs. MAD 1.75. Year-2 ROI of 463% vs. 75%.
4. **Stronger competitive moat:** 6–12 month copy lag vs. 3–6 months for a digital funnel.
...
|---|---|---|
| Phase 1 | Now → Month 6 | Deploy WMD for immediate funnel improvement |
| Phase 2 | Month 1 → Month 18 | Integrate Green Homes into next construction cycle (in parallel) |
| Phase 3 | Month 18+ | Both strategies run simultaneously; WMD drives traffic, AGH closes conviction |

**Combined mature upside: MAD 60–90M in additional gross profit** — the two strategies are additive, not substitutable.

However, if only one strategy can be selected as the primary long-term approach, the quantitative evidence favors AGH decisively on cost efficiency, margin predictability, and sustainable competitive advantage.
...
|---|---|---|---|
| 01 — Integration Design | Months 1–3 | Supplier negotiations, feature selection per unit type, MAD 6,000 cost certification | Signed supplier contracts |
| 02 — Pilot Construction | Months 4–9 | 500–1,000 green units in 2–3 projects, energy measurement vs. control units | Units delivered on time and budget |
| 03 — Campaign Launch | Months 6–10 | "Tkhallas dar w tn9es l facture" across Facebook/Instagram, showroom mockups, sales training | Lead generation cost and volume |
| 04 — Validate | Months 10–14 | Measure premium acceptance rate, sales velocity, actual energy savings | **Premium acceptance ≥ 80%** |
| 05 — Portfolio Rollout | Months 15–18+ | Extend to all new projects, standardize suppliers, launch sub-brand | Green units as % of total portfolio |

**Critical KPI:** The pilot's single most important metric is **premium acceptance rate**. If below 65%, do not scale — fix the messaging or the savings calculator first. Above 85%, the premium likely has room to increase.
...
- **Predictability:** Per-unit margin is structural, not behavioral
- **Defensibility:** 6–12 month competitive moat vs. 3–6 months
- **Customer value:** MAD 30,000 in 10-year savings vs. zero post-purchase benefit

The strategy's headline — **"A House That Pays You Back"** — captures both the company and client proposition in one phrase. For Addoha, every green unit adds MAD 1,000 to gross profit. For the buyer, every month brings MAD 250 in savings. The product creates its own marketing through word-of-mouth from satisfied residents.

While WMD offers faster time-to-impact and lower execution risk, these advantages are tactical, not strategic. In the medium and long term, a product-led differentiation strategy with embedded margin and permanent customer value will outperform a funnel optimization strategy that can be replicated by any well-funded competitor within a single budget cycle.

**The economics are compelling. The execution risk is real. The pilot will determine which one dominates — but the numbers favor Green Homes.**
